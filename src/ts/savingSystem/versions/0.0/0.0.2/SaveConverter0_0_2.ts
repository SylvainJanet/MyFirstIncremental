...
export const SaveConverter0_0_2: ISaveConverter0_0 = {
  ...
  convertBack(save: ISaveVersioned): ISaveDataInstance0_0 {
    ...
    if (modifiedSave.version > this.version + 1) {
      if (this.nextSaveConverter === null) {
        throw new ErrorCustom(
          ErrorType.SaveIntegrity,
          ErrorCode.SAVECONVERTER_CONVERTBACK_ISLASTVERSION_0_0_2,
    ...
    if (modifiedSave.version === this.version + 1) {
      ...
      throw new ErrorCustom(
        ErrorType.SaveIntegrity,
        ErrorCode.SAVECONVERTER_CONVERTBACK_VERSIONERROR_0_0_2,
    ...
    throw new ErrorCustom(
      ErrorType.SaveIntegrity,
      ErrorCode.SAVECONVERTER_CONVERTBACK_VERSIONCONVERSIONERROR_0_0_2,
  ...
  convertBackFromNext(save: ISaveVersioned): ISaveDataInstance0_0 {
    if (save.version !== this.version + 1) {
      throw new ErrorCustom(
        ErrorType.SaveIntegrity,
        ErrorCode.SAVECONVERTER_CONVERTBACKFROMNEXT_0_0_2,
  ...
  convertForwardFromPrevious(save: ISaveVersioned): ISaveDataInstance0_0 {
    if (save.version !== this.version - 1) {
      throw new ErrorCustom(
        ErrorType.SaveIntegrity,
        ErrorCode.SAVECONVERTER_CONVERTFORWARDFROMPREVIOUS_0_0_2,
